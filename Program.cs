            ...
            while (true)
            {
                ...
                else if (menuOption == 7)
                {
                    if (File.Exists(LocalFilePath))
                    {
                        ...
                        Console.WriteLine("samogloski");
                        int[] c = StringHelper.CountDiffLetters(s);
                        string ve = s.Replace("q", "").Replace("w", "").Replace("r", "").Replace("t", "").Replace("p", "").Replace("s", "").Replace("d", "").Replace("f", "").Replace("g", "").Replace("h", "").Replace("j", "").Replace("k", "").Replace("l", "").Replace("z", "").Replace("x", "").Replace("c", "").Replace("v", "").Replace("b", "").Replace("n", "").Replace("m", "");
                        ...
                        Console.WriteLine("spolgloski");
                        string va = s.Replace("a", "").Replace("e", "").Replace("i", "").Replace("o", "").Replace("u", "");
                        int[] vc = StringHelper.CountDiffLetters(va);
                        for (int i = 0; i < (int)char.MaxValue; i++)
                        {
                            if (c[i] > 0 && char.IsLetter((char)i))
                            {
